...
export const PROJECTS = [
  ...
  // ---- volcano plots: ported from HighResSlideshowExports, public since 2026-08-14 ----
  { key: "clocktx", label: "Transcriptome vs the Clock" },
  { key: "stages", label: "Across the Stages" },
  { key: "animalveg", label: "Animal–Vegetal Enrichment" },
  { key: "contacthalves", label: "Contact Halves" },
